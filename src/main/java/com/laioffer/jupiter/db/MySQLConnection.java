...
public class MySQLConnection {
    ...
    public void setFavoriteItem(String userId, Item item) throws MySQLException {
        ...
        saveItem(item);
        // Insert a favorite data to favorite_records table
        // method1
        //String sql = String.format("INSERT IGNORE INTO favorite_records (user_id, item_id) VALUES (%s, %s)", userId, item.getId();
        // method2: Using ? and preparedStatement to prevent SQL injection
    ...
    public boolean addUser(User user) throws MySQLException {
        ...
        try {
            ...
            return statement.executeUpdate() == 1;  // insert success
        } catch (SQLException e) {
            e.printStackTrace();
